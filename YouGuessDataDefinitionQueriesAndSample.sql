...
INSERT INTO `YouTube_Channels` VALUES (0, 'SyKe', 16, 'https://yt3.ggpht.com/ytc/AKedOLTvs0ScA2dRb2zjwR6fPdCLgAwKTVIiOlLLjfzBTg=s88-c-k-c0x00ffffff-no-rj'), (1, 'PewDiePie', 111000000, 'https://yt3.ggpht.com/5oUY3tashyxfqsjO5SGhjT4dus8FkN9CsAHwXWISFrdPYii1FudD4ICtLfuCw6-THJsJbgoY=s88-c-k-c0x00ffffff-no-rj');
...
CREATE TABLE `YouTube_Videos` (
    ...
    `channelID` INT,
    FOREIGN KEY('channelID') REFERENCES 'YouTube_Channels' ('channelID')
) ENGINE=INNODB;
...
INSERT INTO `Users` (`email`, `password`, `username`) VALUES ('nguyejo5@oregonstate.edu', 'nezuko4ever', 'John');
INSERT INTO `Users` (`email`, `password`, `username`) VALUES ('fullerbl@oregonstate.edu', 'StephenTheGOAT!0', 'Blake');
...
CREATE TABLE Friends_List (
    `userID` int(11) UNIQUE NOT NULL PRIMARY KEY,
    `friendID` int(11) UNIQUE NOT NULL,
    FOREIGN KEY(`userID`) REFERENCES Users (`userID`),
    FOREIGN KEY(`friendID`) REFERENCES Users (`userID`)
) ENGINE=INNODB;

INSERT INTO Friends_List ('friendID') VALUES (1) where `userID`=0; 
INSERT INTO Friends_List ('friendID') VALUES (0) where `userID`=1; 
...
INSERT INTO Items_List ('skipQuantity', `reviveQuantity`) VALUES (99999, 99999) where `userID`=0; 
INSERT INTO Items_List ('skipQuantity', `reviveQuantity`) VALUES (99999, 99999) where `userID`=1; 
